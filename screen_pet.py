...
def hide_happy(event):
    c.itemconfigure(cheek_left, stateHIDDEN)
    c.itemconfigure(cheek_right, stateHIDDEN)
    c.itemconfigure(mouth_happy, stateHIDDEN)
    c.itemconfigure(mouth_normal, stateNORMAL)
    c.itemconfigure(mouth_sad, stateHIDDEN)
    return  
